...
def image_segment_values(size,no_of_images,i):
    savedir = "C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\outputsegment"
    filename = "C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\encrypted_image.jpg"
    image_size=size
    n=no_of_images
    y=name.filename(n,i)
