...
path=glob.glob("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\exp\\*.jpg")
i=1
for file in path:
    print(file)
    ...
    cv2.imwrite("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\resized_images\\image"+str(i)+".jpg", resized)
    cv2.waitKey(0)
...
cv2.imwrite('C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\encrypted_image.jpg',encrypted_image)
cv2.waitKey(0)
cv2.destroyAllWindows()


############################################################################################################
pwlcmimagepath=(r"C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\resized_images\\image1.jpg")
i=0
cp.pwlcm_values(pwlcmimagepath,initial,p,i)

dir = 'C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\outputsegment'
if os.listdir(dir)!= []:
...
path=glob.glob("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\outputsegment\\*.jpg")
i=1
for file in path:
    print(file)
    dp_image = cv2.imread(file)
...
if(a==0):
    ...
    cv2.imwrite('C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\decrypted_image.png',decrypted_image)
...
for i in range(1,n+1):
    path=(r"C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\exp\\{}.jpg".format(i))
    histr1.colorhist(path,i,"Original")

mergepath='C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\Merged_image.jpg'
demergepath='C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\decrypted_image.png'
encryptedpath='C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\encrypted_image.jpg'
...
original_image=Image.open("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\Merged_image.jpg")
image_snr=np.array(original_image)
mean_image=np.mean(image_snr)

img1=Image.open("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\decrypted_image.png")
...
Entropy_img1 = cv2.imread("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\Merged_image.jpg", cv2.IMREAD_GRAYSCALE)
Entropy_img2 = cv2.imread("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\decrypted_image.png", cv2.IMREAD_GRAYSCALE)
np.warnings.filterwarnings('ignore', category=np.VisibleDeprecationWarning)
entropy1 = calcEntropy(Entropy_img1)
entropy2 = calcEntropy(Entropy_img2)

easygui.msgbox("Entropy Of Merged Image = {}".format(entropy1), title="Entropy Of Merged Image")
...
loc1=(r"C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\Merged_image.jpg")
loc2=(r"C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\encrypted_image.jpg")
