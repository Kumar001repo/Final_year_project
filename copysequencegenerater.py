...
def pwlcm_values(path,initial,p,i):
    ...
    #demo=cv2.imread("C:\\Users\\Hacke\\Desktop\\Final year project codes backup\\encryptdecrypt\\image1.jpg")
...
cv2.imwrite("C:\\Users\\ABHIRAM\\Desktop\\pwlcmencrypt\\encrypted_image.png",demo)
cv2.waitKey(0)
